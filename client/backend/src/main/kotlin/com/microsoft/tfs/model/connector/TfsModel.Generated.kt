...
package com.microsoft.tfs.model.host
...
class TfsModel private constructor(
    ...
    val getBasicWorkspaceInfo: IRdEndpoint<TfsLocalPath, TfsWorkspaceInfo?> get() = _getBasicWorkspaceInfo
    val getDetailedWorkspaceInfo: IRdEndpoint<TfsDetailedWorkspaceRequest, TfsDetailedWorkspaceInfo?> get() = _getDetailedWorkspaceInfo
    //methods
    //initializer
    init {
...
class TfsCollection private constructor(
     ...
     */
    val getPendingChanges: IRdEndpoint<List<TfsPath>, List<TfsPendingChange>> get() = _getPendingChanges
    
    /**
     * Provides information on local repository items
     */
    val getLocalItemsInfo: IRdEndpoint<List<TfsLocalPath>, List<TfsLocalItemInfo>> get() = _getLocalItemsInfo
    
    /**
     * Provides extended information (i.e. including locks) on local repository items
     */
    val getExtendedLocalItemsInfo: IRdEndpoint<List<TfsLocalPath>, List<TfsExtendedItemInfo>> get() = _getExtendedLocalItemsInfo
    
    /**
     * Invalidates the paths in the TFS cache
     */
    val invalidatePaths: IRdEndpoint<List<TfsLocalPath>, Unit> get() = _invalidatePaths
     ...
     */
    val addFiles: IRdEndpoint<List<TfsLocalPath>, List<TfsLocalPath>> get() = _addFiles
    
    /**
     * Scheduled deletion of the files
     */
    val deleteFilesRecursively: IRdEndpoint<List<TfsPath>, TfsDeleteResult> get() = _deleteFilesRecursively
     ...
     */
    val undoLocalChanges: IRdEndpoint<List<TfsPath>, List<TfsLocalPath>> get() = _undoLocalChanges
    
    /**
     * Makes one or more local files writable and creates "edit" pending changes for them in the current workspace.
     */
    val checkoutFilesForEdit: IRdEndpoint<TfvcCheckoutParameters, TfvcCheckoutResult> get() = _checkoutFilesForEdit
    
    /**
     * Creates a "rename" pending change, which moves or renames a file or folder. Returns success status
     */
    val renameFile: IRdEndpoint<TfvcRenameRequest, Boolean> get() = _renameFile
    //methods
    //initializer
    init {
